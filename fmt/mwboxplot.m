function hout=mwboxplot(x,varargin)
...
switch plotstyle
    ...
    hh=boxrenderer(ax,posns,widths,vert, ...
        'lineAlongResponse',{'locationstart',boxhi,'locationend',whishi,...
            'linestyle','--','linewidth',linewidth,'linecolor',whiscolor,...
            'tag','Upper Whisker'},...
        ...
        'lineBoxNotched',{'locationstart',boxlo,'locationend',boxhi,...
            ...
            'notchdepth',notchdepth,'linestyle','-','linewidth',linewidth,'linecolor',boxcolor,...
            'tag','Box'},...
        'lineAlongFactor',{'location',med,'linelength',1-notchdepth,...
            'linestyle','-','linewidth',linewidth,'linecolor',medcolor,...
            'tag','Median'},...
    ...
    hh=boxrenderer(ax,posns,widths,vert, ...
        'lineAlongResponse',{'locationstart',whislo,'locationend',whishi,...
            'linestyle','-','linewidth',linewidth,'linecolor',boxcolor,...
            'tag','Whisker'},...
